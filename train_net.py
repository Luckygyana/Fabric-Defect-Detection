...
def parse_args():
    ...
    parser.add_argument(
        "--GPU", type=int, required=True, help="ID of GPU used for training/evaluation."
    )
    parser.add_argument(
        "--RUN_NAME",
        type=str,
    ...
    parser.add_argument(
        ...
        required=False,
        default=None,
        help="Size of dilation kernel for labels",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Which fold (KSDD) or class (DAGM) to train.",
    )
    parser.add_argument(
        "--TRAIN_NUM",
        type=int,
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=None,
        help="Whether to validate on test set.",
    )
    parser.add_argument(
        "--VALIDATION_N_EPOCHS",
        type=int,
    ...
    parser.add_argument(
        "--SAVE_IMAGES", type=str2bool, default=None, help="Save test images or not."
    )
